              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: t500_18.copyWith(color: const Color(0xff676767)),
                      ),
                    ],
                  ),
                ),
                ...
                Consumer<HomeManager>(
                  builder: (context, hMgr, child) {
                    return Container(
                      decoration: const BoxDecoration(color: Color(0xffFFD166)),
                      child: Column(
                        children: [
                          Container(
                            width: maxWidth,
                            decoration: const BoxDecoration(
                              image: DecorationImage(
                                fit: BoxFit.fitWidth,
                                image: AssetImage(
                                  "assets/images/pet-head-image.png",
                                ),
                              ),
                            ),
                            child: Padding(
                          ...
                          // verticalSpace(h1p),
                          hMgr.publicForumVeterinaryListModel?.publicForums !=
                                  null
                              ? SizedBox(
                                  // height: 80,
