...
import 'package:dqapp/view/screens/pet_care_screens/boarder_details_screen.dart';
...
import '../../../model/core/pet_boarders_list_model.dart';
import '../../../model/helper/service_locator.dart';
import '../../theme/constants.dart';
import '../location_drawer_screen.dart';

class BoardersListScreen extends StatefulWidget {
  const BoardersListScreen({Key? key}) : super(key: key);

  @override
  State<BoardersListScreen> createState() => _BoardersListScreenState();
}

class _BoardersListScreenState extends State<BoardersListScreen>
  ...
  @override
  void initState() {
    getIt<PetsManager>().getPetBoardersList();
    super.initState();
  }

  @override
  void dispose() {
    getIt<PetsManager>().boardersDispose();
    super.dispose();
  }
            ...
            return SafeArea(
              child: Entry(
                ...
                child: Scaffold(
                  ...
                  body: ListView(
                    children: [
                      latLongList.isEmpty && mgr.petBoarders == null
                          ? InkWell(
                              onTap: () async {
                                await showModalBottomSheet(
                                  backgroundColor: Colors.blueGrey,
                          ...
                          : mgr.petBoarders != null &&
                                mgr.petBoarders!.isNotEmpty
                          ? Padding(
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (_) =>
                                                  BoarderDetailsScreen(
                                                    boarderId: item.id!,
                                                  ),
                                            ),
                                          );
                                        },
                                        child: BoardersListItem(
                                          item: item,
                                          w1p: w1p,
                                        ),
                                      );
                          ...
                          : mgr.petBoarders != null && mgr.petBoarders!.isEmpty
                          ? Padding(
...
class BoardersListItem extends StatelessWidget {
  final PetBoarder item;
  final double w1p;
  const BoardersListItem({super.key, required this.item, required this.w1p});
