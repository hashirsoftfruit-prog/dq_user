...
import '../../../councelling_therapy_screens/councelling_list_screen.dart';
import '../../../councelling_therapy_screens/music_list_screen.dart';
import '../../../drawer_menu_screens/upcoming_appoinments_screen.dart';
import '../../../home_screen_widgets.dart';

class ProCounsellingScreen extends StatefulWidget {
  // final String title;
  const ProCounsellingScreen({super.key});

  @override
  State<ProCounsellingScreen> createState() => CounsellingScreenState();
}

class CounsellingScreenState extends State<ProCounsellingScreen> {
      ...
      builder: (context, constraints) {
        ...
        return Consumer<ProHomeVm>(
          builder: (context, vm, child) {
            // var counsellingListModel = vm.counsellingListModel;
            PsychologyData? psychologyData = vm.psychologyData;
            ...
            List<String> hours = psychologyData?.sleepQuality != null
                ? psychologyData!.sleepQuality!
                      ...
                      .toList()
                : [];
            int? selectedEmotion = vm.dailyWellnessDataModel != null
                ? vm.dailyWellnessDataModel!.selectedEmotionCode ??
                      vm.dailyWellnessDataModel!.dailyEmotion?.code
                : null;
            int? selectedSleepQuality = vm.dailyWellnessDataModel != null
                ? vm.dailyWellnessDataModel!.selectedSleepQualityId ??
                      vm
            ...
            return SizedBox(
              ...
              child: Entry(
                ...
                // curve: Curves.ease,
                child: vm.listLoader == true
                    ? myLoader(visibility: true)
                    : CustomScrollView(
                        slivers: [
                          // SliverPersistentHeader(
                          //   delegate: AppBarForCouncelling(
                          //     title1: "Hi $username", title2: "Good Morning", w1p: w1p,
                          //     minHeight: 60,
                          //     maxHeight: 120,
                          //     // slotCount: "${vm.doctorSlotPickModel?.selectedDate?.timeList?.length??0} ${AppLocalizations.of(context)!.slotsAvailable}", // Replace with your asset path
                          //   ),
                          //   pinned: false, // Keeps it at the top while scrolling
                          // ),
                          SliverPadding(
                            padding: const EdgeInsets.only(top: 12.0),
                            sliver: SliverList(
                              delegate: SliverChildListDelegate([
                                // get.searchBarBox(title: "${AppLocalizations.of(context)!.search} ${widget.title}", height: h10p, width: w10p),
                                verticalSpace(h1p),
                                Column(
                                  children: [
                                    Padding(
                                                    ...
                                                    SliderTheme(
                                                      ...
                                                      child: Slider(
                                                        ...
                                                        onChanged: (value) async {
                                                          var res = await vm.updateSleepQualityOrEmotions(
                                                            sleepQualityValue:
                                                                value.toInt(),
                                                            emotionValue: null,
                            ...
                            SliverPadding(
                              ...
                              sliver: SliverGrid(
                                delegate: SliverChildBuilderDelegate((
                                  ...
                                  var title = dashboardTherapies[index].title;
                                  var img =
