...
class PetInstantBookingScreen extends StatefulWidget {
  ...
  @override
  State<PetInstantBookingScreen> createState() =>
      _PetInstantBookingScreenState();
}

class _PetInstantBookingScreenState extends State<PetInstantBookingScreen> {
  bool agreeTerms = false;
  var scollCntr = ScrollController();

  @override
  void initState() {
    // getIt<BookingManager>().getBillDetails(spID:widget.specialityId ,type:null,doctorId: null);
    getIt<PetsManager>().getPetDetails(widget.petId);
    getIt<PetsManager>().getInstantPetBookingDetails(id: widget.petId!);
              ...
              return Scaffold(
                ...
                body: ListView(
                  ...
                  children: [
                    ...
                    // mgr.bookingScreenLoader? SizedBox(height: w1p*60,
                    //     width: w1p*80,
                    //     child: Padding(
                    //       padding: const EdgeInsets.all(28.0),
                    //       child: Lottie.asset('assets/images/doc-search.json'),
                    //     )):mgr.bookingInfoModel?.status==true?Entry(
                    //     xOffset: 1000,
                    //     // scale: 20,
                    //     delay: const Duration(milliseconds: 0),
                    //     duration: const Duration(milliseconds: 1000),
                    //     curve: Curves.ease,child: DocCircle(h1p: h1p,w1p: w1p,data:mgr.bookingInfoModel!)) : SizedBox(),
                    Entry(
                      yOffset: -500,
                      // scale: 20,
                      delay: const Duration(milliseconds: 0),
                          ...
                          children: [
                            ...
                            billModel != null || packageBillModel != null
                                ? payBtn(
                                    ...
                                    bookingDetails: BookingDetailsItem(
                                      petId: widget.petId,

                                      packageDetails:
                                          mgr.selectedPkg?.packageDetails,
                                      specialityId: widget.specialityId,
                                      // couponId: billModel!.couponIdIfApplied,
