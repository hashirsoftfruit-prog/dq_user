...
import '../../../model/core/pet_boarder_details_model.dart';
import '../../../model/helper/service_locator.dart';
import '../../theme/constants.dart';

class BoarderDetailsScreen extends StatefulWidget {
  final int boarderId;
  const BoarderDetailsScreen({super.key, required this.boarderId});

  @override
  State<BoarderDetailsScreen> createState() => _BoarderDetailsScreenState();
}

class _BoarderDetailsScreenState extends State<BoarderDetailsScreen>
    with SingleTickerProviderStateMixin {
  @override
  void initState() {
    getIt<PetsManager>().getPetBoarderDetails(widget.boarderId);
    super.initState();
  }

  @override
  void dispose() {
    getIt<PetsManager>().boarderDetailsDispose();
    super.dispose();
  }
      ...
      builder: (context, constraints) {
        ...
        return Consumer<PetsManager>(
          builder: (context, mgr, child) {
            BoardingDetails? data = mgr.petBoarderDetails;
            String mapUrl =
                  ...
                  child: data != null
                      ? Column(
                          ...
                          children: [
                            ...
                            title(
                              AppLocalizations.of(context)!.whoWeAreHelping,
                            ),
                            Padding(
                              padding: EdgeInsets.symmetric(
                                horizontal: w1p * 4,
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                width: maxWidth,
                                height: 200,
                                // child: CachedNetworkImage().network(mapUrl,fit: BoxFit.fitWidth,)
                                child: CachedNetworkImage(
                                  fit: BoxFit.cover,
                                  // fit: widget.fit,
                                  imageUrl: mapUrl,
