...
class VideoView extends flutter_zoom_view.ZoomView {
  const VideoView({
    super.key,
    required super.user,
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      ...
      //   if (talking) {
      //     Timer(
      //         const Duration(milliseconds: showTalkingIconDuration),
      //         () => {
      //               if (isMounted())
      //                 {
      //                   isTalking.value = false,
      ...
      if (sharing || isVideoOn.value || isPiPView || preview) {
        return Container(
          ...
          child: flutter_zoom_view.View(
              key: Key(viewParamStr), creationParams: creationParams),
        );
        ...
        return Container(
          ...
          alignment: Alignment.center,
          child: flutter_zoom_view.View(
              key: Key(sharing.toString()), creationParams: creationParams),
        );
      } else {
        return Container(
