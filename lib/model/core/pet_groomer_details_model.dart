class PetGroomersDetailsModel {
  bool? status;
  String? message;
  GroomerDetails? groomerDetails;

  PetGroomersDetailsModel({this.status, this.message, this.groomerDetails});

  PetGroomersDetailsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    groomerDetails = json['groomer_details'] != null
        ? GroomerDetails.fromJson(json['groomer_details'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (groomerDetails != null) {
      data['groomer_details'] = groomerDetails!.toJson();
    }
    return data;
  }
}

class GroomerDetails {
  int? id;
  String? name;
  String? logo;
  String? address1;
  ...
  GroomerDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    logo = json['logo'];
