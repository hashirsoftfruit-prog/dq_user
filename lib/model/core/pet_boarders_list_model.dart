class PetBoardersListModel {
  bool? status;
  String? message;
  List<PetBoarder>? petBoarders;

  PetBoardersListModel({this.status, this.message, this.petBoarders});

  PetBoardersListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['pet_boarders'] != null) {
      petBoarders = <PetBoarder>[];
      json['pet_boarders'].forEach((v) {
        petBoarders!.add(PetBoarder.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (petBoarders != null) {
      data['pet_boarders'] = petBoarders!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class PetBoarder {
  ...
  PetBoarder.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    logo = json['logo'];
